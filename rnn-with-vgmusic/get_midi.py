# Ref. https://github.com/gogson/node-vgmusic-downloader/blob/master/lib/crawler.js
# Ref. https://github.com/AlexPoulsen/vgmusic_midi_scraper/blob/master/dl_vgmusic.py
        ...
        for i in range(2, len(tr_list)):
            ...
            if now_tr.get("class") == ['header']:
                ...
                if not now_tr.td.get('colspan'):
                    ...
                    print('%s |%s |%s |%s |%s '%(album_name, song_name, song_size, song_author, song_midi ))
